        ...
        <div class="about-bottom section">
            <div class="container-fluid">
                ...
                <div class="col-md-6 about-bottom-right">
                    <p class="abt-p">Chronicle your best source to buy cheap book online, make online book purchase, making us the best book website in India 
                    </p>
        ...
        <div class="footer-bottom section">
            <div class="container">
                ...
                <div class="subscribe-main section-w3layouts text-center">
                    <h4 class="rad-txt">
                        <span class="abtxt1">Contact Us</span>
                        <span class="abtext">Chronicle</span>
                    </h4>
                    <h5></h5>
                ...
                <div class="footer-cpy">
                    ...
                    <div class="col-md-3 col-sm-6 footer-logo">
                        ...
                        <h4>about us</h4>
                        <p>Chronicle your best source to buy cheap book online, make online book purchase, making us the best book website in India </p>
                    </div>
                    <!-- //footer-grid1 -->
                    <!-- footer-grid2 -->
