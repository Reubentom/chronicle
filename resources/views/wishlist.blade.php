...
<!-- Mirrored from htmldemo.hasthemes.com/furns/furns/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Apr 2021 08:06:53 GMT -->
            ...
            <div class="offcanvas-menu mb-4">
                <ul>
                    <li><a href="#"><span class="menu-text">Home</span></a>
                        <ul class="sub-menu">
                            <li><a href="index.html"><span class="menu-text">sign in</span></a></li>
                            <li><a href="index-2.html"><span class="menu-text">sign up</span></a></li>
                        </ul>
                    </li>
                    <li><a href="about.html">About Us</a></li>
                ...
                <div class="col-12">
                    <div class="row breadcrumb_box  align-items-center">
                        <div class="col-lg-6 col-md-6 col-sm-12 text-center text-md-left">
                            <h2 class="breadcrumb-title">LIBERT-WISHLIST</h2>
                        </div>
